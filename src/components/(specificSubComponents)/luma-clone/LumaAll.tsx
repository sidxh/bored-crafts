...
export function LumaContainer({ children }: { children: React.ReactNode }){
    return (
...
export function LumaBody({ children }: { children: React.ReactNode }){
    return (
...
export function LumaEvents({ children }: { children: React.ReactNode }){
    return (
...
export function LumaEventsNavbar(){
    return (
...
export function LumaEventsCard(props: any){
    return (
